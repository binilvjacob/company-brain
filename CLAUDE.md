...
- NO LangChain/LlamaIndex, NO hosted RAG SaaS, NO agent frameworks, NO fine-tuning, NO auth system (doc-level `visibility` tags + a role dropdown instead), NO real OAuth connectors (adapter interface + mock data + typed Notion stub).
